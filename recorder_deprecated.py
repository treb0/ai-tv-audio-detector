...
def calc_duration(vid_file_path):
    ...
    def probe(vid_file_path):
        ...
        #Give a json from ffprobe command line @vid_file_path : The absolute (full) path of the video file, string.'''
...
sys.path.append('venv/lib/python3.9/site-packages/ffprobe')
